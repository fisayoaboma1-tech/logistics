...
const BentoCard = ({ icon: Icon, title, description }: { icon: LucideIcon; title: string; description: string }) => (
  <div className="overflow-hidden rounded-2xl glass card-hover flex flex-col justify-start items-start relative min-h-[220px]">
    ...
    <div className="self-stretch p-6 flex flex-col justify-start items-start gap-4 relative z-10">
      ...
      <div className="self-stretch flex flex-col justify-start items-start gap-1.5">
        <p className="self-stretch text-foreground text-lg font-semibold leading-7 tracking-tight">{title}</p>
      ...
      <div className="w-full py-8 md:py-16 relative flex flex-col justify-start items-start gap-6">
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            <h2 className="w-full max-w-[655px] text-center text-foreground text-4xl md:text-6xl font-semibold leading-tight md:leading-[66px] heading-tighter">
